---
title: Admin theme
recipe: core_recommended_admin_theme
source: core/recipes/core_recommended_admin_theme/recipe.yml
---

# Admin theme

**Machine name:** `core_recommended_admin_theme`  
**Source:** `core/recipes/core_recommended_admin_theme/recipe.yml`

Sets up Claro as the administrative (backend) theme.
## Type
