---
title: Front end theme
recipe: core_recommended_front_end_theme
source: core/recipes/core_recommended_front_end_theme/recipe.yml
---

# Front end theme

**Machine name:** `core_recommended_front_end_theme`  
**Source:** `core/recipes/core_recommended_front_end_theme/recipe.yml`

Sets up Olivero as the front-end theme.
## Type
